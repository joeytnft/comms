    ...
    <main className="flex-1 p-8">
      ...
      <div className="relative mb-5">
        ...
        <input
          ...
          className="w-full max-w-sm bg-navy-900 border border-white/10 rounded-xl pl-10 pr-4 py-2.5 text-sm text-white placeholder-slate-500 focus:outline-none focus:ring-2 focus:ring-blue-500 transition"
        />
      </div>
